...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
	...
	UIImageView *loadingImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Default-iPad.png"]];
...
-(void)AddGameView{
	...
	game = [[Game alloc] initWithWidth:window.frame.size.width height:window.frame.size.height];
